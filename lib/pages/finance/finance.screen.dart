...
import 'package:carbonix/pages/finance/transaction.widget.dart';
...
class _FinanceScreenState extends State<FinanceScreen> {
  ...
  List<Transaction> _transactions = [
    Transaction(
        from: '1', to: '2', amount: 50.0, timestamp: DateTime.now(), type: 0),
    Transaction(
        from: '1', to: '2', amount: 30.0, timestamp: DateTime.now(), type: 1),
  ];
