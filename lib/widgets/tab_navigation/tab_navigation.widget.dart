                ...
                children: [
                  Pressable(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: pageIndex == 0 ? ThemeColors.text : Colors.white,
                      ...
                      child: Center(
                        child: Icon(
                          ...
                          color:
                              pageIndex == 0 ? Colors.white : ThemeColors.text,
                        ),
                      ),
                    ),
                  ),
                  Pressable(
                    ...
                    child: Container(
                      ...
                      width: (screenWidth - 104) / 4,
                      decoration: BoxDecoration(
                        color: pageIndex == 1 ? ThemeColors.text : Colors.white,
                      ),
                      child: Center(
                        child: Icon(
                          pageIndex == 1
                          ...
                          color:
                              pageIndex == 1 ? Colors.white : ThemeColors.text,
                        ),
                      ),
                    ),
                  ),
                  ...
                  Pressable(
                    ...
                    child: Container(
                      ...
                      width: (screenWidth - 104) / 4,
                      decoration: BoxDecoration(
                        color: pageIndex == 2 ? ThemeColors.text : Colors.white,
                      ),
                      child: Center(
                        child: Icon(
                          pageIndex == 2 ? Ionicons.bag : Ionicons.bag_outline,
                          color:
                              pageIndex == 2 ? Colors.white : ThemeColors.text,
                        ),
                      ),
                    ),
                  ),
                  Pressable(
                    ...
                    child: Container(
                      ...
                      width: (screenWidth - 104) / 4,
                      decoration: BoxDecoration(
                        color: pageIndex == 3 ? ThemeColors.text : Colors.white,
                        borderRadius: const BorderRadius.only(
                      ...
                      child: Center(
                        child: Icon(
                          ...
                          color:
                              pageIndex == 3 ? Colors.white : ThemeColors.text,
                        ),
                      ),
                    ),
                  ),
